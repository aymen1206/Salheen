...
@section('content')
<div class="container" style="background-color: rgb(243, 124, 81)">


    <div class="col">
        <div class="jumbotron">
            <h1 class="display-4">List Of Visas </h1>
...
<td>
    <a class="btn btn-primary btn-lg"  href="{{route('visa.show',['slug'=> $visa->slug])}}">Show</a>
    <a  class="btn btn-success btn-lg"  href="{{route('visa.edit',['id'=> $visa->id])}}">Edit</a>
    <a class="btn btn-danger btn-lg mt-2"  href="{{route('visa.destroy',['id'=> $visa->id])}}">Delete</a>
